...
{
    // Renamed the inner abstract class to avoid CS0542 error
    internal abstract class FBDataModelBase
    {
   ...
   public FBDataModelBase()
        {
            FirebaseAuthConfig fac = new()
            {
                ApiKey = Keys.FbAPIKey,
              AuthDomain= "quartets-4e4f1.firebaseapp.com",
